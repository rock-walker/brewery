...
<head>
    ...
    <script src="catalog/view/theme/<?php echo $theme_path; ?>/js/jquery.malsup.form.min.js" type="text/javascript"></script>
    <script src="catalog/view/javascript/jquery/masked-input/jquery.maskedinput.min.js" type="text/javascript"></script>
